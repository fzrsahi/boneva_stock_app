    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-slate-300 p-6 shadow-lg sm:rounded-lg">
                ...
                @endif
                <form class="mx-auto max-w-full" action="{{ route('employee.update', ['employee' => $employee->uuid]) }}"
                    ...
                    <div class="grid grid-cols-4 gap-4">
                        <div class="col-span-3">
                            <div class="grid grid-cols-2 gap-3">
                                <div class="mb-3">
                                    ...
                                    <input
                                        ...
                                        id="fullname" name="fullname" type="text" value="{{ $employee->fullname }}"
                                        placeholder="Jokowi...." required />
                                </div>
                                <div class="mb-3">
                                    <label class="mb-2 block text-sm font-medium text-gray-900 dark:text-white"
                                        for="nik">NIK</label>
                                    <input
                                        class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500"
                                        id="nik" name="nik" type="number" value="{{ $employee->nik }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input
                                    class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500"
                                    id="department" name="department" type="text" value="{{ $employee->department }}"
                                    required />
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div class="flex items-center justify-center p-5">
                                <img class="h-32 w-32 object-cover" id="imagePreview"
                                    src="{{ asset('profilephoto/' . $employee->profilephoto) }}" alt="" />
                            </div>
                            <div class="mt-3">
